...
<form class="max-w-md mx-auto" method="POST" action="{{route('employees.store')}}">
    ...
    <div class=" w-full mb-5 group">
        ...
        <textarea name="address" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 dark:text-white"></textarea>
